...
public class PowerMi2 extends UiAutomatorTestCase
{
	...
	public void test1PlayGame() throws IOException, UiObjectNotFoundException
	{
		...
		sleep((long) 15000.0);
		getUiDevice().swipe(540, 620, 820, 380, 5);
		sleep((long) 10000.0);
		getUiDevice().swipe(700, 610, 990, 420, 5);
		sleep((long) 2000.0);
		for(int i = 0; i < 19;i++)
		{
			for(int j = 0; j < 25;j++)
			{
				getUiDevice().swipe(110, 380, 1100, 380, 13);
				sleep((long) 2000.0);
			}
			sleep((long) 21000.0);
			...
			sleep((long) 10000.0);
			getUiDevice().swipe(490, 670, 780, 470, 5);
			sleep((long) 2000.0);
		}
	...
	public void test5Weibo() throws IOException, UiObjectNotFoundException
	{
		...
		for(int i = 0; i < 143;i++)
		{
			...
			sleep((long) 10000.0);
			getUiDevice().swipe(20, 1130, 20, 200, 10);
			sleep((long) 5000.0);
			getUiDevice().swipe(20, 1130, 20, 200, 10);
			sleep((long) 5000.0);
			getUiDevice().swipe(20, 1130, 20, 200, 10);
	...
	{ 
		junit.textui.TestRunner.run(PowerMi2.class);
	}
