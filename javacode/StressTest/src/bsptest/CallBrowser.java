...
public class CallBrowser extends UiAutomatorTestCase {  	
		...
		for(int i = 0 ; i < 400 ; i++){
			...
			{
				Log.v("bsptest", "call is successfully!---------------------" + i);
			...
			getUiDevice().pressHome();
				...
				inputResult.write((date1.format(new Date())+"  \n"+failnote+"  \n").getBytes());
  				...
  				sleep((long) 5000.0);
  				Process p5 = Runtime.getRuntime().exec("am force-stop com.android.browser");
  				sleep((long) 10000.0);
				}
			}
