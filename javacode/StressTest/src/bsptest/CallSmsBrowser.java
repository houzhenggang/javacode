...
public class CallSmsBrowser extends UiAutomatorTestCase {   
	...
	public void test_MOCALL() throws UiObjectNotFoundException, RemoteException, IOException, ParserConfigurationException, SAXException{
		...
		sleep((long) 2000.0);
		Process mkdir1 = Runtime.getRuntime().exec("mkdir /sdcard/smsMo");
		File resultReport1=new File("/sdcard/smsMo/fail_list.txt");
		resultReport1.createNewFile();
		FileOutputStream inputResult1=new FileOutputStream(resultReport);
		for(int i = 0 ; i < 300 ; i++){
...
/*	                InputStreamReader read = new InputStreamReader(new FileInputStream(logcatFile), encoding); */ 
	                ...
	                if ((lineTXT = bufferedReader.readLine()) != null) {  
	                     ...
	                     else
	                     {
	        				...
	        				inputResult1.write((date1.format(new Date())+"  \n"+failnote+"  \n").getBytes());
	          				sleep((long) 3000.0);
