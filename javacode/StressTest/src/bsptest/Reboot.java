...
public class Reboot extends UiAutomatorTestCase
{		
		...
		@SuppressWarnings("unused")
		public void testA() throws UiObjectNotFoundException, RemoteException, IOException, ParserConfigurationException, SAXException{
			...
			for(int i = 0 ; i < 100 ; i++){
				...
				sleep((long) 1000.0);
				Process p2 = Runtime.getRuntime().exec("reboot");
				sleep((long) 30000.0);
				getUiDevice().wakeUp();
			    sleep((long) 1000.0);
			    Process r1 = Runtime.getRuntime().exec("sendevent /dev/input/event5 1 115 1");
		...
		public static void main(String args[]){ 
			junit.textui.TestRunner.run(Reboot.class);
			}
